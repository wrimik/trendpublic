...
$(document).ready(function() {
    ...
    $(document).on('click', '.to-do-list input[type=checkbox]', function() {
    ...
    // search
    $(document).on("#search-friends", "keyup", function() {
    ...
    $(document).on("keyup", "#m-search",  function() {
        var g = $(this).val().toLowerCase();
    ...
    // open messages
    $(document).on('click', '.header-user-list .userlist-box', function() {
        $('.header-chat').addClass('open');
        $('.header-user-list').toggleClass('msg-open');
    });
    // close user list
    $(document).on('click', '.h-back-user-list', function() {
        $('.header-chat').removeClass('open');
        $('.header-user-list').removeClass('msg-open');
    });
    //  full chat
    $(document).on('click', '.h-close-text', function() {
        $('.header-chat').removeClass('open');
    ...
    $(document).on('keyup', '.h-send-chat',function(e) {
        fc(e);
    });
    ...
    // close card
    $(document).on('click', ".card-option .close-card", function() {
        var $this = $(this);
    ...
    // reload card
    $(document).on('click', ".card-option .reload-card", function() {
        var $this = $(this);
    ...
    $(document).on('click',".card-option .minimize-card", function() {
        var $this = $(this);
    ...
    // full card
    $(document).on('click', ".card-option .full-card", function() {
        var $this = $(this);
        var port = $($this.parents('.card'));
...
// menu [ Mobile ]
$(document).on('click', "#mobile-collapse,#mobile-collapse1", function(e) {
    var vw = $(window)[0].innerWidth;
    if (vw < 992) {
...
$(window).ready(function() {
    var vw = $(window)[0].innerWidth;
    $(document).on('click tap', ".pcoded-navbar", function(e) {
        e.stopPropagation();
    });
    $(document).on("click", '.pcoded-main-container,.pcoded-header', function() {
        if (vw < 992) {
...
$(document).on('click', '.layout-1 .sidemenu a', function(){
    var port = $(this);
...
$(document).on('click', '.layout-1 .toggle-sidemenu', function(){
    var port = $(this);
